...
import { Barcode, CloudUpload, ImageIcon, Search, X } from "lucide-react"
...
const productSchema = z.object({
    ...
    salePrice: z.number().min(1, "El precio de venta debe ser mayor a 0"),
    purchasePrice: z.number().min(1, "El precio de compra debe ser mayor a 0"),
...
export const ProductFormView = ({ mode, product }: ProductFormViewProps) => {
    ...
    const [previewUrl, setPreviewUrl] = useState<string | undefined>(product?.imageUrl ?? undefined)
    ...
    const handleSubmit = () => {
        ...
        if (mode === 'create') {
            ...
            updateProduct({ id: product.id, ...result.data })
        }
    }
        ...
        <div className="px-6 sm:px-8 py-8 space-y-6">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <Button variant='primary' onClick={handleSubmit} disabled={isPending || isUploading}>
